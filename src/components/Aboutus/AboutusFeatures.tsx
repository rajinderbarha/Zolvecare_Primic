...
import icon from './fi_10328668.png'
        ...
        />
            ...
            heading4: ({ children }) => (
              <h4 className="mb-4 font-semibold text-2xl"> {children}</h4>
                                    ...
                                    {/* <h4 className='mb-4 font-semibold text-2xl'>AI-Driven Documentation</h4> */}
            ...
            paragraph: ({ children }) => (<p className="md:text-lg text-base font-normal leading-8">{children}</p>
                                    ...
                                    {/* <p className='md:text-lg text-base font-normal leading-8'>Zolvecare likely employs AI to automate medical documentation, reducing the time and effort required for healthcare professionals to record patient information.</p> */}
                                </div>
                            </div>
                             ))}
                        </div>
